        ...
        if results.multi_hand_landmarks:
            ...
            if len(lmList) !=0 : # check it is not empty
                ...
                if total==0 :
                    ...
                    cv2.rectangle(image, (20, 100), (270, 225), (0, 255, 0), cv2.FILLED)
                    cv2.putText(image, "Close", (45, 175), cv2.FONT_HERSHEY_SIMPLEX,
                        2, (255, 0, 0), 4)
                    ...
                    cv2.rectangle(image, (20, 100), (270, 225), (0, 255, 0), cv2.FILLED)
                    cv2.putText(image, "Open", (45, 175), cv2.FONT_HERSHEY_SIMPLEX,
                        2, (255, 0, 0), 4)
